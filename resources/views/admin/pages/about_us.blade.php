                      ...
                      <div class="panel-body">
                          ...
                          <div class="row">
                              <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
                                  <form 
                                  @if(isset($data))
                                  action="{{url('admin/about/update/'.$data->id)}}" 
                                  @else
                                  action="{{url('admin/about/save')}}" 
                                  @endif
                                  method="post">
                                    {!! csrf_field() !!}
                        ...
                        <table id="dataTableExample2" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->title}}</td>
                                    <td>
                                        <a href="{{url('admin/about/edit/'.$row->id)}}" class="btn btn-base btn-lm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                         <a href="{{url('SiteSetting/delete/'.$row->id.'/1')}}" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fa fa-trash-o" aria-hidden="true"></i></a> 
                                    </td>
